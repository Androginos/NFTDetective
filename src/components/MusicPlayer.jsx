...
const MusicPlayer = () => {
  ...
  const playlist = [
    { id: 1, name: "Track 1 - Keeping Routine", src: "/music/track1.mp3" },
    { id: 2, name: "Track 2 - Sneak Peek", src: "/music/track2.mp3" },
    { id: 3, name: "Track 3 - I Must Be Dreaming", src: "/music/track3.mp3" },
    { id: 4, name: "Track 4 - Murder on the Artlist Express", src: "/music/track4.mp3" },
    { id: 5, name: "Track 5 - Unfortunate Events", src: "/music/track5.mp3" }
  ];
